...
import '../styles/credit-card-payment.css'
import '../styles/style.css'
import visacard from '../resources/visa-card.webp';
import mastercard from '../resources/master-card.png';
...
class paymentcc extends Component{
  constructor(props) {
    ...
    console.log("type is",this.props.FlightType)
  ...
  componentDidMount() {
    ...
    <div className="checkout_form">
      <div className="company">
        <img src={mastercard} alt="mastercrd" />
...
export default connect(mapStateToProps,mapDispatchToProps)(paymentcc)